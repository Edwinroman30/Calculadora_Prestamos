class Calculadora_Prestamos:
   ...
   #def Cuota_mensual(self):
    ...
    def General_tabla(self):
        #'Pago: {0} | NULL{1} |Saldo Iniciar | CUOTA: {2} | Capital: {3} | Interes: {4} | Balance o Saldo Final: {5}'
        last_index = 0
    ...
    def Mostrar_tabla(self):
        ...
        for x in range(0,(self.plazo),1):
            print('Pago: {} | {} | CUOTA: {} | Capital: {} | Interes: {} | Balance: {}'
                  .format(self.tabla[x][0], self.tabla[x][1] , self.tabla[x][3] , self.tabla[x][4] , self.tabla[x][5] , self.tabla[x][6]))   
...
#calculador.ver()
calculador.Mostrar_tabla()

#print(calculador.tabla[0])
